...
public class CustomReportUtil {
    ...
    public synchronized void generateReport(Map datamap) {
    ...
    protected void startHtml(Map map) throws Exception {
        ...
        m_out.println("<tr style=\"color: #ffffff; background-color:#F08080;\"> <th>Movie ID</th><th>Movie Name</th> <th>Wikipedia URL</th><th>Wikipedia Director(s)</th> <th>Imdb URL</th><th>Imdb Director(s)</th>");
        ...
        while (entries.hasNext()) {
            ...
            m_out.println("<tr style=\"color: #000000; background-color:#ffffff;\"> <th>"+entry.getValue().get(4)+"</th><th>" + entry.getKey() + "</th> <th>" + entry.getValue().get(0) + "</th><th>"+ entry.getValue().get(1) +"</th> <th>"+ entry.getValue().get(2) +"</th><th>"+ entry.getValue().get(3) +"</th>");
